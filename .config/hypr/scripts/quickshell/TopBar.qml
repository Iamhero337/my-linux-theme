...
Variants {
    ...
    delegate: Component {
		...
		running: true
            ...
            Timer { id: volSyncTimer; interval: 200; repeat: false; onTriggered: { audioPoller.running = false; audioPoller.running = true; } }
            Timer { id: audioPeriodicSync; interval: 3000; repeat: true; running: true; onTriggered: { audioPoller.running = false; audioPoller.running = true; } }
                    ...
                    Rectangle {
                        ...
                        Row {
                            ...
                            Rectangle {
                                ...
                                clip: true
                                color: isHovered ? Qt.rgba(mocha.mauve.r, mocha.mauve.g, mocha.mauve.b, 0.25) : Qt.rgba(mocha.surface0.r, mocha.surface0.g, mocha.surface0.b, 0.55)
                                border.width: 1
                                border.color: isHovered ? mocha.mauve : Qt.rgba(mocha.mauve.r, mocha.mauve.g, mocha.mauve.b, 0.25)
                                
                                property real targetWidth: cpuLayoutRow.implicitWidth + barWindow.s(22)
                                width: targetWidth
                                ...
                                Row {
                                    ...
                                    Text {
                                        ...
                                        color: Qt.lighter(mocha.mauve, 1.2)
                                    }
                                }
                                MouseArea { id: cpuMouse; hoverEnabled: true; anchors.fill: parent }
                            }
                            ...
                            Rectangle {
                                ...
                                radius: barWindow.s(10); height: sysLayout.pillHeight;
                                clip: true
                                color: isHovered ? Qt.rgba(mocha.sapphire.r, mocha.sapphire.g, mocha.sapphire.b, 0.25) : Qt.rgba(mocha.surface0.r, mocha.surface0.g, mocha.surface0.b, 0.55)
                                border.width: 1
                                border.color: isHovered ? mocha.sapphire : Qt.rgba(mocha.sapphire.r, mocha.sapphire.g, mocha.sapphire.b, 0.25)
                                
                                property real targetWidth: ramLayoutRow.implicitWidth + barWindow.s(22)
                                width: targetWidth
                                Behavior on width { NumberAnimation { duration: 500; easing.type: Easing.OutQuint } }
                                scale: isHovered ? 1.05 : 1.0
                                Behavior on scale { NumberAnimation { duration: 250; easing.type: Easing.OutExpo } }
                                ...
                                Row {
                                    ...
                                    Text {
                                        anchors.verticalCenter: parent.verticalCenter
                                        text: SysData.ramGb.toFixed(1) + "G"
                                        font.family: "JetBrains Mono"; font.pixelSize: barWindow.s(13); font.weight: Font.Black
                                        color: mocha.text
                                    }
                                    Text {
                                        ...
                                        font.family: "JetBrains Mono"; font.pixelSize: barWindow.s(12); font.weight: Font.Bold
                                        color: Qt.lighter(mocha.sapphire, 1.2)
                                    }
                                }
                                MouseArea { id: ramMouse; hoverEnabled: true; anchors.fill: parent }
                            }
                            ...
                            Rectangle {
                                ...
                                radius: barWindow.s(10); height: sysLayout.pillHeight;
                                clip: true
                                color: isHovered ? Qt.rgba(mocha.green.r, mocha.green.g, mocha.green.b, 0.25) : Qt.rgba(mocha.surface0.r, mocha.surface0.g, mocha.surface0.b, 0.55)
                                border.width: 1
                                border.color: isHovered ? mocha.green : Qt.rgba(mocha.green.r, mocha.green.g, mocha.green.b, 0.25)
                                
                                property real targetWidth: gpuLayoutRow.implicitWidth + barWindow.s(22)
                                width: targetWidth
                                Behavior on width { NumberAnimation { duration: 500; easing.type: Easing.OutQuint } }
                                scale: isHovered ? 1.05 : 1.0
                                Behavior on scale { NumberAnimation { duration: 250; easing.type: Easing.OutExpo } }
                                ...
                                Row {
                                    ...
                                    Text {
                                        anchors.verticalCenter: parent.verticalCenter
                                        text: SysData.gpuUsage + "%"
                                        font.family: "JetBrains Mono"; font.pixelSize: barWindow.s(13); font.weight: Font.Black
                                        color: mocha.text
                                    }
                                    Text {
                                        anchors.verticalCenter: parent.verticalCenter
                                        text: SysData.gpuTemp + "°C"
                                        font.family: "JetBrains Mono"; font.pixelSize: barWindow.s(12); font.weight: Font.Bold
                                        color: Qt.lighter(mocha.green, 1.2)
                                    }
                                }
                                MouseArea {
                                    id: gpuMouse
                                    hoverEnabled: true
                                    anchors.fill: parent
                                    onClicked: Quickshell.execDetached(["bash", "-c", "~/.config/hypr/scripts/qs_manager.sh toggle gpu"])
                                }
                            }
                            ...
                            Rectangle {
                                ...
                                function formatNetSpeed(bytes) {
                                    if (isNaN(bytes) || bytes <= 0) return "0 KB/s";
                                    if (bytes >= 1048576 * 10) {
                            ...
                            Rectangle {
                                ...
                                MouseArea { 
                                    ...
                                    onWheel: (wheel) => {
                                        ...
                                        let nextVol = cur;
                                        if (delta > 0) {
                                            nextVol = Math.min(100, cur + 5);
                                            Quickshell.execDetached(["wpctl", "set-volume", "-l", "1.0", "@DEFAULT_AUDIO_SINK@", "5%+"]);
                                        } else {
                                            nextVol = Math.max(0, cur - 5);
                                            Quickshell.execDetached(["wpctl", "set-volume", "@DEFAULT_AUDIO_SINK@", "5%-"]);
                                        }
                                        barWindow.volPercent = nextVol + "%";
                                        barWindow.volIcon = (nextVol >= 70) ? "󰕾" : (nextVol >= 30 ? "󰖀" : (nextVol > 0 ? "󰕿" : "󰝟"));
                                        barWindow.isMuted = (nextVol === 0);
